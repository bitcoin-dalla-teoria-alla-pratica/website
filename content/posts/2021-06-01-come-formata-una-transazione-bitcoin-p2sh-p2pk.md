...
Negli articoli precedenti abbiamo analizzato come è costruito un [address P2SH-P2PK](/posts/come-creare-un-address-p2sh-p2pk-bitcoin/), e in questa introduzione andremo invece ad analizzare come è costruita la transazione.
...
Esatto, il redeem script, è posizionato nello **scriptSig**, gli stessi elementi che sono stati utilizzati per [creare l’address](/posts/come-creare-un-address-p2sh-p2pk-bitcoin/) negli articoli precedenti.
...
Ad esempio, per lo script **P2PKH**, nello scriptSig troveremo la firma digitale e la chiave pubblica, esattamente come una normale [P2PKH](/posts/transazione-p2pkh-nel-bitcoin-playground/).
