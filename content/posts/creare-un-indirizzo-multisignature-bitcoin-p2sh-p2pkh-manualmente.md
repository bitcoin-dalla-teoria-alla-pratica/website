...
<pre class="wp-block-syntaxhighlighter-code">for i in 1 2 3
do
...
<pre class="wp-block-syntaxhighlighter-code">SCRIPT="5221"$(cat compressed_public_key_1.txt)"21"$(cat compressed_public_key_2.txt)"21"$(cat compressed_public_key_3.txt)"53AE"</pre>
...
<pre class="wp-block-syntaxhighlighter-code">cat compressed_public_key_1.txt | wc -m</pre>
...
<pre class="wp-block-syntaxhighlighter-code">printf $SCRIPT > redeem_script.txt</pre>
...
<pre class="wp-block-syntaxhighlighter-code">######### P2SH #########
...
03d9f8e4487229f0bd3f3af5ce4b6301930f18de
 ...
 ---------- 🔑 ADDRESS P2SH️ ---------
2Msbb8qRdT5N3YJYc8BDbQ25sMJQUuKUKMW</pre>
